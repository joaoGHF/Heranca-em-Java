...
/**
 * <p>A classe {@code Aluno} extende a classe {@code Pessoa} para a sua especialização em um tipo Aluno.</p>
 * @see Pessoa
 */
public class Aluno extends Pessoa {
	...
	/**
	 * <p>Método construtor da classe {@code Aluno} com implementação do construtor {@code super()} para a progenitora {@code Pessoa}.</p>
	 ...
	 * juntamente os atributos declarados na classe {@code Aluno}.</p>
	 */
	@Override
