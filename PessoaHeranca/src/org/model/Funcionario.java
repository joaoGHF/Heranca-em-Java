...
/**
 * <p>A classe {@code Funcionario} extende a classe {@code Pessoa} para a sua especialização em um tipo Funcionario.
 * E é extendida pela classe {@code Coordenador}</p>
 * @see Pessoa
 * @see Coordenador
 */
public class Funcionario extends Pessoa {
	...
	/**
	 * <p>Método construtor da classe {@code Funcionario} com implementação do construtor {@code super()} para a progenitora {@code Pessoa}.</p>
	...
	/**
	 * <p>Sobreescita do  método {@code printThis()} de {@code Pessoa}. Chama o método {@code super.printThis()} e imprime
	 * juntamente os atributos declarados na classe {@code Funcionario}.</p>
	 */
	@Override
